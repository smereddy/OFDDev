                ...
                <div class="col-sm-12 form-group well well-sm">
                    <div class="col-sm-4">
                        <a class="btn btn-success dropdown-toggle col-sm-12" type="button"
                           href="Fillable_PDFs\Accident Module\(Accident PDF) LRS 101 City of Omaha Vehicle Accident Report.pdf"
            ...
            <div class="row">
                ...
                <div class="col-sm-12 form-group well well-sm">
                    <div class="col-sm-4">
                        ...
                        <a class="btn btn-success dropdown-toggle col-sm-12" type="button"
                           href="Fillable_PDFs\Accident Module\(Accident PDF) OFD 295 Vehicle Accident Witness Statement.pdf"
